...
Either get it from the Chrome Web Store:
https://chromewebstore.google.com/detail/azure-devops-wiki-clone-p/ndfegibldghikdekddhaolpkdidmaklo

Or install it manually with the latest zip file in the [/releases](releases) folder by following the Google Chrome guide:
